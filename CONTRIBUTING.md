...
If you find a bug in the source code, you can help by [submitting an issue](#submitting-an-issue) to  [HashnodeNG](https://github.com/HashnodeNG).
...
1. Search [HashnodeNG](https://github.com/HashnodeNG) for an open or closed PR that relates to your submission.
